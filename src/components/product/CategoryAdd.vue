  ...
  <a-modal
    ...
    <a-form-model ref="ruleForm" :model="form" :rules="rules"
      ...
      <a-row :gutter="16">
        ...
        <a-col :md="24" :lg="12">
          <a-form-model-item label="Category Banner: " prop="banner" help="Image size 800 X 300">
    ...
    return {
      ...
      rules: {
        name: [
          ...
          {max: 50, message: 'Category name maximum length 50 character', trigger: 'blur'},
        ],
        name_bd: [
          {required: true, message: 'বিভাগের নাম আবশ্যক', trigger: 'blur'},
          {max: 100, message: 'বিভাগের নাম সর্বাধিক দৈর্ঘ্য 100 অক্ষর', trigger: 'blur'},
        ],
        banner: [
