<template>
  <div>
    ...
    <div id="people" class="dataTables_wrapper no-footer my-5">
      <v-client-table :data="categoryList" :columns="columns" :options="options" class="text-center">
        ...
        <div slot="icon" slot-scope="props">
          <img :src="showImage(props.row.icon)" class="border" width="60px">
        </div>
...
export default {
  ...
  computed: {
    ...
    columns() {
      return this.isBangla ? ['serial', 'name', 'name_bd', 'banner', 'icon', 'action'] : ['serial', 'name', 'banner', 'icon', 'action'];
    },
    options() {
      return {
        headings: {
