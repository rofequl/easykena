  ...
  <a-layout style="padding: 0 24px 24px" class="fcontent">
    <div class="container">
          ...
          <div class="bg-white all-category-menu">
            <ul class="d-flex flex-wrap no-scrollbar">
              <li v-for="categories in categoryList" :key="categories.id">
                <a href="javascript:" class="row align-items-center">
                  <div class="col-md-3">
                    <img class="cat-image"
      ...
      <div class="my-3 bg-white" v-for="categories in categoryList" :key="categories.id" :id="'na'+categories.id">
        <div class="sub-category-menu p-4" id="0">
          ...
          <div class="row">
            <div class="col-lg-4 col-6" v-for="subcategories in subcategoryById(categories.id)"
...
export default {
  name: "AllCategory",
  computed: {
    ...mapGetters(["categoryList", "subcategoryList", "subsubcategoryList", "subcategoryById", "subsubcategoryById"]),
  }
